...
export default function Layout({ title, children }) {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-[#181818] dark:via-[#232323] dark:to-[#181818] text-foreground">
      <header className="py-4 px-6 flex items-center justify-between shadow-lg bg-white/80 dark:bg-[#181818]/90 backdrop-blur-md sticky top-0 z-30 border-b border-gray-200 dark:border-[#232323]">
        <Link href="/" className="text-3xl font-extrabold tracking-tight text-blue-700 dark:text-blue-400 flex items-center gap-2">
      ...
      <div className="flex justify-center py-2">
        <div className="bg-gradient-to-r from-blue-100 to-blue-200 dark:from-[#232323] dark:to-[#181818] text-gray-500 rounded-xl w-full max-w-2xl h-12 flex items-center justify-center shadow-inner border border-blue-100 dark:border-[#232323]">
      ...
      <footer className="py-6 px-6 text-center text-sm text-gray-500 border-t border-gray-200 dark:border-[#232323] mt-8 bg-white/70 dark:bg-[#181818]/80 backdrop-blur-md">
