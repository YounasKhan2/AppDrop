...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-gray-900 text-white p-4 flex flex-col sm:flex-row items-center justify-between z-50">
      <span className="mb-2 sm:mb-0">We use cookies to personalize ads and analyze traffic. By using this site, you agree to our <Link href="/privacy-policy" className="underline">Privacy Policy</Link>.</span>
